                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                children: [
                                  BigText(
                                    text: value.searchList.isNotEmpty
                                        ? value.searchList[index]['cityName']
                                        : value.citiesModel![index].cityName!,
                          ...
                          Row(
                            ...
                            children: [
                              BigText(
                                text: value.citiesModel![index].weather!,
                                color: AppColors.white,
                              ),
                              SmallText(
                                text: value.searchList.isNotEmpty
